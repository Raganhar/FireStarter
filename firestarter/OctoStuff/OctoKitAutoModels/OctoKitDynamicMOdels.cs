...
namespace firestarter.OctoStuff.OctoKitAutoModels
{
    ...
    public partial class graphQlResult
    {
        public static graphQlResult FromJson(string json) => JsonConvert.DeserializeObject<graphQlResult>(json, Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this graphQlResult self) => JsonConvert.SerializeObject(self, Converter.Settings);
    }
